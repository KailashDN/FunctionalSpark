...
/**
 * handle the delays for each website in a non-blocking way.
 * To achieve that we placed this process in a separate class.
 * In addition to this, we need to recover after the scraping failure somehow.
 * @param supervisor
 * @param indexer
 */
